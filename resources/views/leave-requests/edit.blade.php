                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="leave_policy_id"
                                                        ...
                                                        @foreach($leavePolicies as $leave_policy)
                                                            <option
                                                                {{ old('leave_policy_id',$leaveRequest->leave_policy_id) == $leave_policy->id ? 'selected':'' }} value="{{ $leave_policy->id }}">{{ $leave_policy->title }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control datepicker" name="start_date"
                                                           value="{{ old('start_date',$leaveRequest->start_date) }}" id="start_date"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control datepicker" name="end_date"
                                                       value="{{ old('end_date',$leaveRequest->end_date) }}" id="end_date" autocomplete="off"
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="status"
                                                                id="status">
                                                            @foreach(\App\Constants\LeaveStatus::status as $status)
                                                                <option
                                                                    {{ old('status',$leaveRequest->status) == $status ? 'selected':'' }} value="{{ $status }}">{{ $status }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('status')
                                                        <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="leave_reason" id="leave_reason"
                                                          cols="30" rows="2">{{ old('leave_reason',$leaveRequest->leave_reason) }}</textarea>
                                                @error('leave_reason')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
